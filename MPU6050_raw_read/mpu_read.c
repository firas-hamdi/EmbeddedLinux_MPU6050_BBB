...
/*These are the addresses of mpu6050 from which will be fetched accelerometer x,y,z high and low values */
...
/*These are the addresses of mpu6050 from which will be fetched gyro x,y,z high and low values */
...
/* by default mpu6050 will in sleep mode, so disable its sleep mode and configure the full scale ranges for gyro and acc
 */
void mpu6050_init()
{
...
int main(void)
{
    ...
    while(1)
    {
        ...
        /* Convert gyro raw values into (deg/seconds) */
